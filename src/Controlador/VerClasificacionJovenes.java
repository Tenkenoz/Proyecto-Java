 ...
 * @author rouss
 */
public class VerClasificacionJovenes implements VerClasificacion{
    ...
    public void mostrarResultados(ClasificacionesDAO dao, ClasificacionGeneralFrm vista) {
        vista.lblClasificaciones.setText("Clasificacion de los Jóvenes");
        ArrayList<Ciclista> clasificacionG=dao.mostrarClasificacionJovenes();
        ...
        vista.jtClasificaciones.setSelectionBackground(Color.BLACK);
    }
}
